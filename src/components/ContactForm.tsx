...
export function ContactForm({ onClose }: ContactFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs.send(
      import.meta.env.VITE_EMAILJS_SERVICE_ID || 'service_8esl8wr',
      import.meta.env.VITE_EMAILJS_TEMPLATE_ID || 'template_wa84bw7',
      templateParams,
      import.meta.env.VITE_EMAILJS_PUBLIC_KEY || '3xJHrGFTGXPgQMtws'
    )
      .then((response) => {
